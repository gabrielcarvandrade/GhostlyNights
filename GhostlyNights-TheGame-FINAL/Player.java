...
public class Player extends Actor 
{
    ...
    public void act() 
    {
        ...
        if (estaVivo) 
        {
            ...
            if (modoAutomatico)
            {
                lancaMagiaAutomatico();
                lancaMagiaUltAutomatico();
            }
    ...
    public void removeJogador() 
    {
        ...
        // Verifica se o mundo nao eh nulo e remove todas barras e o player
        if (world != null) 
        {
    ...
    {
        //Caso os pontos de ult nao estejam no maximo ja, adiciona mais um ponto de ult
        addInimigosMortos();
     ...
     */
    private void lancaMagiaAutomatico()
    {
     ...
     * Adiciona uma bola de fogo que vai em direçao ao inimigo mais proximo de tempo em tempo
     */
    private void lancaMagiaUltAutomatico()
    {
        if(pontosUlt >= 20)
        {
            if(Inimigo.class!=null)
     ...
     * Adiciona uma bola de fogo que vai em direçao ao inimigo mais proximo de tempo em tempo
     */
    private void lancaMagiaUltManual()
    {
        if(pontosUlt >= 20)
        {
            if (Greenfoot.isKeyDown("SPACE")) 
